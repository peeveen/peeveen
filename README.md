...
- 2025 onwards: [KPMG](https://kpmg.com/uk/en.html)
  - Creation of AI agents, frameworks and UI tools _(C#, Azure, Microsoft Agent Framework)_
  - Creation of common file access framework _(C#, Microsoft Graph, iManage)_ and design of protected agent file access system.
  - Creation of static asset server for UI _(C#, NGINX)_
...
- Amateur musician
- Keen karaoke singer and former host (using my own [KaraokeManager](https://github.com/peeveen/karaokemanager) software and [display](https://github.com/peeveen/gen_cdgPro) and [audio](https://github.com/peeveen/gen_autoDJ) [plugins](https://github.com/peeveen/gen_singersQueue))
